...
@router.get("/movies/", response_model=MovieListResponseSchema, tags=["movies"], summary="Get all movies")
async def get_movies(page: int = Query(1, alias="page", ge=1), 
...
@router.get("/movies/{movie_id}/", response_model=MovieDetailResponseSchema, tags=["movies"], summary="Get movie by ID")
